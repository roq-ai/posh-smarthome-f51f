...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Product Manager'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['UIUX Designer', 'Backend Developer', 'Product Manager', 'Mobile Web Developer'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `POSH SmartHome`;
  const tenantName = `POSH Smart Home`;
